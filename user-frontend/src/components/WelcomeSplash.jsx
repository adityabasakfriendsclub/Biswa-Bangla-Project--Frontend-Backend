...
// //   const toggleAbout = () => {
// //     setShowAbout(!showAbout);
// //     if (showPolicy) setShowPolicy(false); // Close policy when opening about
// //   };

// //   const togglePolicy = () => {
// //     setShowPolicy(!showPolicy);
// //     if (showAbout) setShowAbout(false); // Close about when opening policy
// //   };
...
// //                       Biswa Bangla Social Networking Services (Club)
// //                     </span>{" "}
// //                     operates under comprehensive policies to ensure a safe,
// //                     ethical, and compliant platform for all users.
// //                   </p>

// //                   <div className="grid md:grid-cols-2 gap-4 mt-6">
// //                     <div className="bg-white/5 rounded-lg p-4 border border-emerald-500/30">
// //                       <h3 className="font-bold text-emerald-400 text-sm mb-2">
// //                         Privacy Policy
// //                       </h3>
// //                       <p className="text-xs text-gray-400">
// //                         Your personal information is protected with our strict
// //                         privacy standards and encryption protocols.
// //                       </p>
// //                     </div>

// //                     <div className="bg-white/5 rounded-lg p-4 border border-blue-500/30">
// //                       <h3 className="font-bold text-blue-400 text-sm mb-2">
// //                         Terms & Conditions
// //                       </h3>
// //                       <p className="text-xs text-gray-400">
// //                         Comprehensive guidelines for using our platform
// //                         responsibly and ethically.
// //                       </p>
// //                     </div>

// //                     <div className="bg-white/5 rounded-lg p-4 border border-purple-500/30">
// //                       <h3 className="font-bold text-purple-400 text-sm mb-2">
// //                         Community Guidelines
// //                       </h3>
// //                       <p className="text-xs text-gray-400">
// //                         Rules for respectful interaction and positive community
// //                         engagement.
// //                       </p>
// //                     </div>

// //                     <div className="bg-white/5 rounded-lg p-4 border border-amber-500/30">
// //                       <h3 className="font-bold text-amber-400 text-sm mb-2">
// //                         Children & Minors
// //                       </h3>
// //                       <p className="text-xs text-gray-400">
// //                         Strict policies to protect minors and ensure
...
// //                       </h3>
// //                       <p className="text-xs text-gray-400">
// //                         Information about delivery timelines and shipping
// //                         procedures.
// //                       </p>
// //                     </div>

// //                     <div className="bg-white/5 rounded-lg p-4 border border-green-500/30">
// //                       <h3 className="font-bold text-green-400 text-sm mb-2">
// //                         Contact Us
// //                       </h3>
// //                       <p className="text-xs text-gray-400">
// //                         Reach out to our support team for any inquiries or
// //                         assistance.
// //                       </p>
// //                     </div>
// //                   </div>
...
// //                       <strong>Note:</strong> All policies are regularly reviewed
// //                       and updated to comply with current laws and regulations.
// //                       For the most accurate and up-to-date information, please
// //                       visit our official policy pages.
// //                     </p>
// //                   </div>
// //                 </div>
// //               </div>
...
// // Import legal page components (as requested)
// import PrivacyPolicyPage from "../pages/legal/PrivacyPolicyPage";
// import TermsConditionsPage from "../pages/legal/TermsConditionsPage";
// import CommunityGuidelinesPage from "../pages/legal/CommunityGuidelinesPage";
// import ChildrenMinorsPage from "../pages/legal/ChildrenMinorsPage";
...
//                     <Link
//                       to="/Privacy-Policy"
//                       className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg border border-gray-700 hover:border-gray-500 transition-all duration-300 text-sm sm:text-base font-medium text-cyan-300 hover:text-cyan-100"
...
//                     <Link
//                       to="/Terms-Conditions"
//                       className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg border border-gray-700 hover:border-gray-500 transition-all duration-300 text-sm sm:text-base font-medium text-blue-300 hover:text-blue-100"
...
//                       className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg border border-gray-700 hover:border-gray-500 transition-all duration-300 text-sm sm:text-base font-medium text-purple-300 hover:text-purple-100"
...
//                     <Link
//                       to="/Children-Minors"
//                       className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg border border-gray-700 hover:border-gray-500 transition-all duration-300 text-sm sm:text-base font-medium text-amber-300 hover:text-amber-100"
...
//                     <Link
//                       to="/Shipping-Policy"
//                       className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg border border-gray-700 hover:border-gray-500 transition-all duration-300 text-sm sm:text-base font-medium text-green-300 hover:text-green-100"
...
//                     <Link
//                       to="/Contact-Us"
//                       className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg border border-gray-700 hover:border-gray-500 transition-all duration-300 text-sm sm:text-base font-medium text-emerald-300 hover:text-emerald-100"
