...
//   const newPassword =
//     location.state?.newPassword || localStorage.getItem("resetPassword");
...
//     try {
//       const response = await fetch(`${API_URL}/host/verify-reset`, {
//         method: "POST",
...
// new2
// FILE: frontend/src/components/auth/VerifyReset.jsx
...
const VerifyReset = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${API_ENDPOINT}/host/verify-reset`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          phone,
