...
// // ✅ FIXED: Robust base URL handling with detailed logging
...
//     console.log("🔧 [DEV MODE] Using API Base URL:", baseURL);
//   } else {
//     baseURL = envURL || "https://biswabanglasocialnetworkingservices.com";
//     console.log("🚀 [PROD MODE] Using API Base URL:", baseURL);
//   }
...
//     console.warn("⚠️ Using fallback URL:", baseURL);
//   }
...
//       console.warn("🔐 Auth failed - Clearing localStorage");
...
//   // ========== AUTH ==========
//   signup: (data) => {
//     console.log("📝 Signup request:", { phone: data.phone });
//     return axios.post(`${API_URL}/host/signup`, data);
//   },

//   verifySignup: (data) => {
//     console.log("✅ Verify signup request:", { phone: data.phone });
//     return axios.post(`${API_URL}/host/verify-signup`, data);
//   },

//   login: (data) => {
//     console.log("🔐 Login request for phone:", data.phone);
//     return axios.post(`${API_URL}/host/login`, data);
//   },
...
//     api.post("/host/account/upload-video", formData, {
//       headers: { "Content-Type": "multipart/form-data" },
//     }),
//   getVideos: () => api.get("/host/account/myvideos"),
//   deleteVideo: (videoId) => api.delete(`/host/account/myvideos/${videoId}`),
...
// new
// FILE: frontend/src/services/api.js
// ✅ FIXED: Corrected video upload endpoint to match backend
